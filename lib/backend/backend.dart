...
import 'schema/company_verification_record.dart';
import 'schema/relation_user_company_record.dart';
...
export 'schema/company_verification_record.dart';
export 'schema/relation_user_company_record.dart';
...
Stream<List<CompanyVerificationRecord>> queryCompanyVerificationRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(CompanyVerificationRecord.collection,
        CompanyVerificationRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Stream<List<RelationUserCompanyRecord>> queryRelationUserCompanyRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(RelationUserCompanyRecord.collection,
